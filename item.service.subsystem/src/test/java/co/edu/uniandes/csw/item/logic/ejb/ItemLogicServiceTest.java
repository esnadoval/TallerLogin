...
public class ItemLogicServiceTest {
	...
	private void insertData() {
		for(int i=0;i<3;i++){
			...
			pdto.setProductsId(generateRandom(Long.class));
	...
	public void createItemTest(){
		...
		ldto.setProductsId(generateRandom(Long.class));
		...
		Assert.assertEquals(ldto.getProductsId(), pdto.getProductsId());	
	}
	...
	public void getItemTest(){
		...
		Assert.assertEquals(pdto.getProductsId(), ldto.getProductsId());
	...
	public void updateItemTest(){
		...
		Assert.assertEquals(ldto.getProductsId(), resp.getProductsId());	
	}
