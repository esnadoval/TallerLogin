...
public class ItemPersistenceTest {
	...
	private void insertData() {
		for(int i=0;i<3;i++){
			...
			entity.setProductsId(generateRandom(Long.class));
			em.persist(entity);
			data.add(entity);
		}
	}
	...
	public void createItemTest(){
		...
		dto.setProductsId(generateRandom(Long.class));
		...
		Assert.assertEquals(dto.getProductsId(), entity.getProductsId());	
	}
	...
	public void getItemTest(){
		...
		Assert.assertEquals(entity.getProductsId(), dto.getProductsId());
	...
	public void updateItemTest(){
		...
		Assert.assertEquals(dto.getProductsId(), resp.getProductsId());	
	}
