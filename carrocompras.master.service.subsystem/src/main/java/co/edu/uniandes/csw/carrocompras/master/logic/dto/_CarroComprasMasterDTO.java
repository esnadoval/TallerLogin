package co.edu.uniandes.csw.carrocompras.master.logic.dto;
...
@XmlRootElement
public abstract class _CarroComprasMasterDTO {

 
    protected CarroComprasDTO carrocomprasEntity;
    protected Long id;
    ...
    public CarroComprasDTO getCarroComprasEntity() {
        return carrocomprasEntity;
    }

    public void setCarroComprasEntity(CarroComprasDTO carrocomprasEntity) {
