...
public class ClientePersistenceTest {
	...
	private void insertData() {
		for(int i=0;i<3;i++){
			...
			entity.setRole(generateRandom(String.class));
			em.persist(entity);
			data.add(entity);
		}
	}
	...
	public void createClienteTest(){
		...
		dto.setRole(generateRandom(String.class));
	...
	public void getClienteTest(){
		...
		Assert.assertEquals(entity.getRole(), dto.getRole());
	...
	public void updateClienteTest(){
		...
		Assert.assertEquals(dto.getRole(), resp.getRole());	
	}
