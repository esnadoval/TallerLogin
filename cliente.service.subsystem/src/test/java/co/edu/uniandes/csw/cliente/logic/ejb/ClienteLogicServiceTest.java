...
public class ClienteLogicServiceTest {
	...
	private void insertData() {
		for(int i=0;i<3;i++){
			...
			pdto.setRole(generateRandom(String.class));
	...
	public void createClienteTest(){
		...
		ldto.setRole(generateRandom(String.class));
		...
		Assert.assertEquals(ldto.getRole(), pdto.getRole());	
	}
	...
	public void getClienteTest(){
		...
		Assert.assertEquals(pdto.getRole(), ldto.getRole());
	...
	public void updateClienteTest(){
		...
		Assert.assertEquals(ldto.getRole(), resp.getRole());	
	}
